...
def camera_stream():
    ...
    def perform_object_detection(frame):
        ...
        for cell in empty_cells:
            ...
            cv2.rectangle(result_image, (cell_x + 15, cell_y + 10), (cell_x + cell_width - 20, cell_y + cell_height - 10), (0, 0, 255), 2)  # 빨간색 사각형 그리기
        ...
        root.attributes('-fullscreen', True) # 전체화면 처리
    ...
    threshold_values = [3.3,8,49]  # 임계값 리스트
